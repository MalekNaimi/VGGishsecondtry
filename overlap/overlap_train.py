...
f = h5py.File('/content/VGGishsecondtry/overlap/train.hdf5','r')
...
f2 = h5py.File('/content/VGGishsecondtry/overlap/val.hdf5','r')
val_data,val_label = f2['val_data'],f2['val_label']
val_labeled_data = list(zip(val_data,val_label))

f3 = h5py.File('/content/VGGishsecondtry/overlap/test.hdf5','r')
