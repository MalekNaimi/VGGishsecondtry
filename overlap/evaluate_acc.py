...
with open('/content/VGGishsecondtry/overlap/test_clip_length.txt','r') as f:
    line = f.readline().split()
test_clip_length = [int(x) for x in line]

with open('/content/VGGishsecondtry/overlap/test_preds.txt','r') as f:
    line = f.readline().split()
test_preds = [int(x) for x in line]

with open('/content/VGGishsecondtry/overlap/test_labels.txt','r') as f:
    line = f.readline().split()
test_labels = [int(x) for x in line]

with open('/content/VGGishsecondtry/overlap/test_logits.txt','r') as f:
    line = f.readlines()
